  ...
  return (
    <section className="py-6 sm:py-10 lg:py-14">
      <div className="container mx-auto px-3 sm:px-4">
        {/* Section Header */}
        <div className="pb-3 sm:pb-4 border-b border-gray-100 relative after:absolute after:w-20 sm:after:w-28 after:rounded-full after:bottom-0 after:left-0 after:h-1 after:bg-brand">
