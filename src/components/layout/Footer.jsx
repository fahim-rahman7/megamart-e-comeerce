      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="text-theme">
            <h3 className="font-semibold text-xl pb-4 border-b-2 w-fit">Most Popular Categories</h3>
          ...
          <div className="text-theme">
            <h3 className="font-semibold text-xl pb-4 border-b-2 w-fit">Customer Services</h3>
            <ul className="mt-5 list-disc pl-6 space-y-4">
                <li>
                    <Link>Staples</Link>
                </li>
        ...
        <div>
         <h4 className="text-theme text-center py-7.5 border-t-2 mt-20 border-theme/50">© 2022 All rights reserved. Reliance Retail Ltd.</h4>
         </div>
      </div>
    </footer>
  );
